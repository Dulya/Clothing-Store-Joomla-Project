...
class JHtmlAcysmsselect extends JHTMLSelect {
	...
	public static function booleanlist($name, $attribs = null, $selected = null, $yes = 'JYES', $no = 'JNO', $id = false){
		$arr = array(JHtml::_('select.option', '0', JText::_($no)),JHtml::_('acysmsselect.option', '1', JText::_($yes)));
		$arr[0]->class = 'btn-danger';
		$arr[1]->class = 'btn-success';
		return JHtml::_('acysmsselect.radiolist', $arr, $name, $attribs, 'value', 'text', (int) $selected, $id);
	}
