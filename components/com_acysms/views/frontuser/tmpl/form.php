...
?><fieldset id="acysms_user_form_menu">
	...
	<div class="acyheader" style="float: left;"><h1><?php echo JText::_('SMS_USER'); ?></h1></div>
</fieldset>
<?php
if(!empty($this->Itemid)) echo '<input type="hidden" name="Itemid" value="'.$this->Itemid.'" />';
include(ACYSMS_BACK.'views'.DS.'user'.DS.'tmpl'.DS.'form.php'); ?>
