...
<div class="minifrontpage-tabbed-slide-left-right" id="minifrontpage-<?php echo $mfpid; ?>">
<div id="mfptabs"></div>
<div style="display:table;table-layout:fixed;width:100%;padding:0 !important; margin:0 !important;" class="minifrontpageid">
	<div class="anim">
	<div class="anim-div" style="position:relative;">
		<?php for($row=1; $row<=$number_of_row;$row++){ ?>
			<?php if( $animate_row_count == 1 ) : ?>
			...
			<?php endif; ?>
				<div class="mfp-table-row" style="display:table-row;100%;">
					...
					<div class="mfp-table-cell" style="display:table-cell;width:<?php echo $column_percentage_inner; ?>%;word-wrap:break-word !important">
	...
	<?php if($show_more_article){ ?>
	<div class="mfp-other-article" style="display:table-cell;width:<?php echo $column_percentage; ?>%;">
